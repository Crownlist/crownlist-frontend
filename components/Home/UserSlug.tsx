    ...
    <div className="p-4 md:p-12">
      ...
      <div className="flex flex-col md:flex-row items-start gap-6 mb-8">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-wrap gap-3">
            <Button
              variant="outline"
              className="flex items-center gap-2 rounded-full shadow-none hover:shadow"
            >
      ...
      <div className="bg-[#f0eeff] rounded-full p-1 inline-flex mb-8 w-full ">
        <Link
          ...
          className={`px-6 py-2 rounded-full ${
            activeTab === "details"
              ? "bg-white text-[#1a0066] font-medium shadow-sm"
      ...
      <div>
        ...
        <div className="flex gap-3">
          <Button className="bg-[#1a0066] hover:bg-[#150050] rounded-full">
            Update
          </Button>
