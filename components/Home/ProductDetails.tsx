      ...
      <div className=" w-full  mx-auto">
          ...
          <div className="bg-white p-6 rounded-lg border w-full shadow-md md:shadow-lg">
            ...
            <div className="mb-6">
              <div className="flex items-center gap-2">
                ...
                >
                  ₦{product?.price?.currentPrice?.toLocaleString() || "N/A"}
                </span>
              </div>
            </div>
            {/* Added Posted Date */}
            ...
            <div className="flex gap-4 mb-6">
              <div className="flex items-center gap-1 bg-gray-100 px-3 py-1.5 rounded-full">
                ...
                <span className="text-xs">
                  {product?.listingLocation?.city || "Location"}
                </span>
              </div>
              <div className="flex items-center gap-1 bg-gray-100 px-3 py-1.5 rounded-full">
                <svg
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between w-full gap-3">
                <Button
                  variant="outline"
                  className="w-full rounded-full border-[#1F058F] text-[#1F058F] hover:bg-[#1F058F] hover:text-white"
            ...
            <div className="mt-6 w-full">
              ...
              <div className="flex gap-1 md:gap-3">
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="flex items-center border-none gap-1 md:gap-2 text-xs"
                >
                  <Copy size={14} />
                  Copy link
                </Button>
        ...
        {view === "contactInfo" && (
          <div className="bg-white p-6 rounded-lg border w-full">
            ...
            <div className="flex items-center gap-3 mt-4">
              ...
              <div>
                ...
                <p className="text-sm flex items-center p-2">
                  ...
                  {product?.ratings?.averageRating || 0} positive feedback
                </p>
              </div>
            </div>

            <button
              className="border py-2 px-4 w-full mt-4 mb-2 rounded-lg hover:bg-gray-100"
              onClick={() => setView("default")}
            >
              See Store
            </button>
            ...
            <button
              className="border rounded-lg py-2 px-4 w-full mt-2 hover:bg-gray-100"
              onClick={() => setView("default")}
            >
              Cancel
            </button>
        ...
        {view === "sendMessage" && (
          <div className="bg-white p-6 rounded-lg border w-full">
            ...
            <p>
              Type your message, enquiry, or concern for the Seller to answer
            </p>
            <textarea
              placeholder="Message"
        ...
        {view === "confirmEscrow" && (
          <div className="bg-white p-6 rounded-lg border w-full">
            ...
            <div className="my-4 p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-xs text-gray-600">
                You will pay this amount to escrow. Funds will be released to
                the seller only after you confirm receipt.
              </p>
            </div>
            <Button
