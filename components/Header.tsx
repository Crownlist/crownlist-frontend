...
import MobileCategoryView from "./Mobile-Category";
...
const Header = ({ hidden }: props) => {
  ...
  // If category view is shown, render that instead of the regular header
  if (showCategoryView) {
    return <MobileCategoryView onClose={() => setShowCategoryView(false)} />;
  }
        ...
        >
          <div className="h-full flex flex-col p-6">
            ...
            <div className="space-y-4 mb-6">
              ...
              <Link
                href="#"
                className="block text-[#141414] font-medium text-[10px]"
                onClick={() => setMobileMenuOpen(false)}
              >
                Post Product
              </Link>
                      ...
                      <Button
                        ...
                        className={`${
                          pathname == "/cwwategory"
                            ? "border-b-gray-950"
                            : "border-none"
                        }  shadow-none px-2 py-3 rounded-[99px] text-[#141414] font-medium `}
                        variant="outline"
                      >
                        <div className="flex flex-row gap-1 align-middle">
                          <div className="flex items-center">
