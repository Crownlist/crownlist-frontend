...
export default function ProductDetailPage() {
    ...
    const handleCloseModal = () => {
      setIsDeleteModalOpen(false); // Function to close the modal
    };
    ...
    return (
        <div className=" mx-auto px-4 py-3 md:py-6 relative">
            {/* Breadcrumb */}
            <div className='flex max-md:flex-col w-full md:justify-between  md:mb-5'>
                ...
                <div className="flex gap-2 justify-end w-full">
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <button className="outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1 rounded-md">
            ...
            {isDeleteModalOpen && (
                <DeleteConfirmationModal
                    ...
                    onClose={handleCloseModal} // Pass the closing function
                />
            )}
        </div>
    )
