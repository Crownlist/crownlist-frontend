...
export default function PricingPage() {
  ...
  return (
    <div className="py-6 px-4 md:px-6  mx-auto">
      <h1 className="text-2xl font-bold mb-6">Settings</h1>

      {/* Tabs */}
      <div className="border rounded-lg mb-8 border-[#1F058F]">
        <div className="flex">
          <Link href="/seller/settings/profile"  className="px-6 py-4 text-gray-700 hover:bg-gray-50">
            Profile
          </Link>
          <Link href="/seller/settings/billings" className="px-6 py-4 text-gray-700 hover:bg-gray-50">
            Billings
          </Link>
          <Link href="/seller/settings/pricing" className="px-6 py-4 text-white bg-[#1F058F] rounded-l-lg font-medium">
            Pricing
          </Link>
        </div>
      </div>
