        ...
        <>
          ...
          <div className="flex gap-1 sm:gap-2 mb-6 border-[1.5px] border-[#1F058F] p-2 rounded-md">
            {["all", "live", "reviewing", "decline"].map((status) => (
              <Button
                key={status}
                className={`px-4 sm:px-5 rounded-md ${
                  activeFilter === status
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-3 w-full h-[100%] justify-start  align-middle">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <Button className="text-[#1F058F] border border-[#1F058F] hover:bg-[#2e0a94] bg-transparent  hover:text-white px-1 lg:px-4 py-1  rounded-full text-[12px]">
                          Promote
                        </Button>
                      </div>
                    </div>
