...
export default function ProductDetailPage() {
  ...
  const fetchServices = async () => {
    try {
      ...
      router.push(`/search/${id}`);
      if (
        e.response?.data?.code === "RESOURCE_NOT_FOUND" ||
      ...
      <div className="container mx-auto px-2 py-6 max-md:px-5">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
          ...
          <span className="text-gray-700 truncate">
            {product?.name || String(id || "").toUpperCase()}
          </span>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 md:justify-between w-full">
            ...
            <div className=" w-full">
              ...
              <div className="space-y-4">
                    ...
                    <AccordionContent className="mt-2 space-y-4">
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-white">
                          ...
                          <tbody>
                            {(
                              product?.facility?.facilities || overviewData
                            ).map((item: any, index: number) => (
                              <tr
                                key={index}
                                className="bg-white text-[#525252]"
                              >
                      ...
                      <p className="text-[#525252] text-sm mt-4">
                        16 bed en suite property to let, 4 wheelchair access
                        bedrooms, with communal kitchens and dining/lounge
                        areas. Reception/office with a surveillance monitor.
                        CCTV throughout inside and out.
                      </p>
                    </AccordionContent>
                  </AccordionItem>
                        ...
                        {reviews.map((review: any) => (
                          <div key={review.id} className="space-y-4">
                            ...
                            <div className="flex items-center gap-4 text-gray-400 text-sm">
                              ...
                              <span>|</span>
                              <button className="flex items-center gap-1">
                                <span className="text-lg">✉️</span> Reply
                                messages
                              </button>
                            </div>
                          </div>
                ...
                {/* Safety Tips Section */}
                <div className="mt-8 bg-[#1f058f] text-white p-6 rounded-lg">
